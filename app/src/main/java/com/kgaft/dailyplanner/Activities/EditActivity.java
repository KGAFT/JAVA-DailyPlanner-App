...
/*
THis class serves activity with edit page
 */
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainInfo =findViewById(R.id.AddMainInfo);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Receiving the information from fields
                ...
                db.updateGoalById(Integer.parseInt(intent.getStringExtra("id")), goalToAdd);
                Intent secondIntent = new Intent(view.getContext(), MainActivity.class);
